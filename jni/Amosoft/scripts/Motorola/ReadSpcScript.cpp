...
#include "IMotorolaScript.cpp"

namespace Amosoft::Scripts::Motorola
{
    class ReadSpcScript : public IMotorolaScript
    {
        private:
        ...
        public:
			...
			ReadSpcScript(InitilizeHandle& handle) : IMotorolaScript(handle) {}
