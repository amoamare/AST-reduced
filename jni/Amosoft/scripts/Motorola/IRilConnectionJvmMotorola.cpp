#ifndef IRILCONNECTIONJVMMOTOROLA_H
#define IRILCONNECTIONJVMMOTOROLA_H
...
#include "IRilConnectionMotorola.cpp"
...
namespace Amosoft
{
	class IRilConnectionJvmMotorola : public Amosoft::IRilConnectionMotorola
	{
    private:
    ...
    public:
			#ifdef NDEBUG
			IRilConnectionJvmMotorola(const AuthModel& authModel_) : IRilConnection(authModel_)
			{
			...
			#else
			IRilConnectionJvmMotorola()
			{
				DESCRIPTOR = String16("com.android.internal.telephony.ITelephony");// String16("com.android.internal.telephony.ITelephony");
			...
			bool ReadImeiData()
			{
				...
				Parcel parcel;
				Parcel reply;
				parcel.writeInterfaceToken(String16("com.android.internal.telephony.ITelephony"));
