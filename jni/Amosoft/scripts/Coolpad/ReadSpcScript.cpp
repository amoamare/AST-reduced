...
#include "ICoolpadScript.cpp"

namespace Amosoft::Scripts::Coolpad
{
    class ReadSpcScript : public ICoolpadScript
    {
        private:
        ...
        public:
			...
			ReadSpcScript(InitilizeHandle& handle) : ICoolpadScript(handle) {}
